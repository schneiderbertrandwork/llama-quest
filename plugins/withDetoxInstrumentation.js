  ...
  config = withDangerousMod(config, [
    ...
    async (mod) => {
      ...
      const javaContent = [
        ...
        '    // devClientHost is a ReactHostWrapper; .getReactNativeHost() unwraps it',
        '    // to the actual ReactNativeHost that Detox needs for its WS handshake.',
        '    return DevLauncherController.getInstance().getDevClientHost().getReactNativeHost();',
        '  }',
        '}',
        '',
